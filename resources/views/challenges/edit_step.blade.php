...
@section('content')
    <div class = "container">
        <h1>Editing: {{$target_step->name}}</h1>
    ...
    @if($steps->isNotEmpty())
        ...
        <form method="POST" action="{{ route('challenges.update_step', ['step'=> $target_step,'challenge' => $challenge])}}">
            @csrf
            ...
            <div class="tab-content" id="challenge-tabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab"><br>
                    ...
                    <textarea name="stepinput" id="stepinput" class="summernote">{{$target_step->text}}</textarea><br>
